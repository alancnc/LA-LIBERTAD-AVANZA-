    ...
    <div className="page">
      ...
      {closed ? (
        ...
        <div className="card" style={{ marginBottom: '1.5rem' }}>
          ...
          <p className="muted">
            Lo que se manda en esta clase va firmado: no se aceptan preguntas ni respuestas
            anónimas. Tu nombre queda guardado en este dispositivo, así lo escribís una sola vez.
          </p>
            ...
            <form onSubmit={handleSubmit} className="stack">
              <div>
                ...
                <p className="muted" style={{ margin: '0.3rem 0 0' }}>
                  {text.length}/{MAX_TEXT_LENGTH} · Si alguien ya preguntó lo mismo, tu pregunta
                  se suma a ese tema y lo empuja arriba en el ranking.
                </p>
              </div>
              {formError && <div className="error">{formError}</div>}
              {ultima && (
